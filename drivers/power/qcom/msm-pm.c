...
/*zte_pm ++++ Interface For Ril Open F3 Log bein*/
...
/*
show sleep gpio info:
step1: let device in airplane mode
step2: echo 512 > /sys/module/msm_pm/parameters/debug_mask
step3: unplug usb
step4: adb shell cat /d/zte_gpio/debug_sleep_gpio
*/
...
/*zte_pm ++++ for record sleep/wake info*/
typedef struct {
...
static int kernel_sleep_count;/*zte_pm*/
...
#endif
/*zte_pm ---- GPIO debug end*/

/*zte_pm +++ record sleep/wake info*/
